...
public class InstrumentationAgent
{
	 ...
	 * @param inst
	 *            Handle to instance of Instrumentation provided on
	 *            command-line.
	 */
	 ...
	 *         (described in Instrumentation.getObjectSize(Object)'s Javadoc as
	 *         "an implementation-specific approximation of the amount of
	 *         storage consumed by the specified object").
	...
	public static void main(String args[])
	{
		...
		//MainAppSettings set = new MainAppSettings();
		System.out.println(" d " + getObjectSize(d));
	}
}
