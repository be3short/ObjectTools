 ...
 * 
 * Might run this class as shown next: java -javaagent:dist\agent.jar -cp
 * dist\agent.jar dustin.examples.InstrumentSampleObjects
 * 
 * @author Dustin
 */
public class InstrumentSampleObjects
{
	 ...
	 * 
	 * @param object
	 *            Object whose value and size are to be printed to standard
	 *            output.
	 */
